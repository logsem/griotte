...
Section Adequacy.
  ...
  Proof.
      ...
      )%I as "#Hinterp_LSE".
    {
      ...
      iApply (lse_awkward_safe
                _ _ _
                _ _ _
                _ _ W0 assertN switcherN lseN lseN
             ); try iFrame "#"; eauto.
      + solve_ndisj.
      + solve_ndisj.
      + solve_ndisj.
    ...
    assert (related_sts_pub_world W0 (std_update_compartment W0 C_cmpt)) as Hrelated_pub_W0_W1.
    ...
    iAssert
      ( interp W1 C (WSealed (ot_switcher switcher_cmpt) C_f)
      )%I as "Hinterp_C_f".
    {
