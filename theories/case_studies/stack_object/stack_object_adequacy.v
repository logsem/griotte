...
Section Adequacy.
  ...
  Proof.
    ...
    pose proof (
        @so_init_spec Σ ceriseg seal_storeg _ _ _ _ _ _ _ _ _ C
      ) as Spec.
    ...
    set (SO_f := (SCap true RO Global _ _ (cmpt_exp_tbl_pcc main_cmpt ^+ 2)%a)).
    set (SO_f' := (SCap true RO Local _ _ (cmpt_exp_tbl_pcc main_cmpt ^+ 2)%a)).
