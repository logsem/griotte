...
Section fundamental.
  ...
  Definition ftlr_instr_base (W : WORLD) (C : CmptName) (regs : leibnizO Reg)
    ...
    (w : Word) (P : V) (Pinstr : Prop) (cstk : CSTK) (Ws : list WORLD) (Cs : list CmptName)
    : Prop :=
    validPCperm p g
  ...
  Definition ftlr_instr (W : WORLD) (C : CmptName) (regs : leibnizO Reg)
    (p p' : Perm) (g : Locality) (b e a : Addr)
    (w : Word) (i: instr) (P : V) (cstk : CSTK) (Ws : list WORLD) (Cs : list CmptName)
    : Prop :=
    ftlr_instr_base W C regs p p' g b e a w P (decodeInstrW w = i) cstk Ws Cs.
