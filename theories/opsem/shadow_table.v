...
Inductive AllocStatus := ShadowLive | ShadowQuarantined.

#[global] Instance alloc_status_eq_dec : EqDecision AllocStatus.
Proof. solve_decision. Defined.

Definition ShadowTbl := gmap Addr AllocStatus.
