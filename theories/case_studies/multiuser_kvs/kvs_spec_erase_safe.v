...
From griotte Require Import
  switcher kvs kvs_preamble kvs_spec_check_uint16 kvs_spec_erase.
...
Section KVS_spec_erase.
  ...
  Lemma kvs_erase_entry_point_spec
    ...
    WSealed ot_switcher (SCap true RO g_kvs_exp_tbl b_kvs_exp_tbl e_kvs_exp_tbl kvs_erase_exp_tbl_addr) ↦□ₑ kvs_erase_nargs ∗
    WSealed ot_switcher (SCap true RO Local b_kvs_exp_tbl e_kvs_exp_tbl kvs_erase_exp_tbl_addr) ↦□ₑ kvs_erase_nargs
    -∗
    ot_switcher_prop W C (WCap true RO g_kvs_exp_tbl b_kvs_exp_tbl e_kvs_exp_tbl kvs_erase_exp_tbl_addr).
  Proof.
    iIntros
    ...
    { iPureIntro. eapply disjoint_from_shadow_not_in.
      ...
      - apply withinBounds_true_iff.
        rewrite /kvs_erase_exp_tbl_addr /kvs_erase_exp_tbl_off; solve_addr. }
    iSplit.
    { iPureIntro. eapply disjoint_from_shadow_not_in.
      - exact kvs_exp_tbl_disjoint_from_shadow.
    ...
    iApply (KVS_erase_spec_safe W0 (revoke W0) _ _ _ _ _ Hunsealing_shadow);
