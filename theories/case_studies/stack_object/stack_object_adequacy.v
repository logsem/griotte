...
Section Adequacy.
  ...
  Proof.
    ...
    (*   solve_addr+H. *)
    (* } *)
    (* rewrite main_data /so_main_data in Hv; simplify_eq. *)
    iAssert (
    ...
    set (W4 := std_update_compartment W0 C_cmpt).
    assert (related_sts_pub_world W0 (std_update_compartment W0 C_cmpt)) as Hrelated_pub_W0_W4.
