...
From cap_machine Require Import rules_Store.
...
Section fundamental.
  ...
  Lemma create_store_res
    ...
    -∗ open_region W C a
    -∗ sts_full_world W C
    -∗ allow_store_res W C r1 r2 (<[PC:=WCap p g b e a]> regs) a p' true
    ∗ sts_full_world W C.
  Proof.
    iIntros (HVr1 Hfl Hwoa) "#Hreg #Hinva Hr Hsts".
  ...
  Qed.
   ...
   Lemma store_case (W : WORLD) (C : CmptName) (regs : leibnizO Reg)
     ...
     ftlr_instr W C regs p p' g b e a w (Store dst src) ρ P cstk Ws Cs wstk.
   Proof.
