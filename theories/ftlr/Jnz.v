...
Section fundamental.
  ...
  Lemma jnz_case (W : WORLD) (C : CmptName)  (regs : leibnizO Reg)
    ...
    (w : Word) (ρ : region_type) (rimm : Z + RegName) (rcond : RegName) (P:D) (cstk : CSTK) (Ws : list WORLD) (wstk : Word)
    (Nswitcher : namespace) :
    ftlr_instr W C regs p p' g b e a w (Jnz rimm rcond) ρ P cstk Ws wstk Nswitcher.
  Proof.
