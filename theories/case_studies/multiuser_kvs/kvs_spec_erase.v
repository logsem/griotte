...
Section KVS_spec_erase.
  ...
  Lemma KVS_erase_spec_in_pre_gen
    (pc_b pc_e pc_a : Addr)
    (cgp_b cgp_e : Addr)
    (wret : Word)
  ...
  Proof.
    ...
    iIntros (HsubBounds Hbounds_a_user_key Hbounds_user_key His_uint16_nkey Hcgp_contiguous Hs')
      "(HPC & Hcgp & Hcra & Hca0 & Hca1 & Hctp & Hct1 & Hct2 & [%wcnull Hcnull] &
        Hcode & Ha_unsealing & Ha_user_key & HKVS & Halloc & [%fkey_w Hkvs_frag] & Hpost)".
    iApply KVS_erase_spec_in_pre_gen; eauto; iFrame "∗%".
  ...
  Proof.
    ...
    iNext; iIntros "(HPC & Hcgp & Hcra & Hca0 & Hca1 & Hctp & Hct1 & Hct2
              & Hcnull & HKVS & Halloc & Hcode & Ha_unsealing & Ha_user_key)".
    subst hcont; unfocus_block "Hcode" "Hcont" as "Hcode".
  ...
  Lemma KVS_erase_spec_notin_pre_gen
    (pc_b pc_e pc_a : Addr)
    (cgp_b cgp_e : Addr)
    (wret : Word)
    (user_key nkey : Z) (wsb : Sealable) (user_key_addr : Addr)
  ...
  Proof.
    iIntros (HsubBounds Hbounds_a_user_key Hbounds_user_key His_uint16_nkey Hcgp_contiguous Hs')
      "(HPC & Hcgp & Hcra & Hca0 & Hca1 & Hctp & Hct1 & Hct2 & [%wcnull Hcnull] &
        Hcode & Ha_unsealing & Ha_user_key & HKVS & Halloc & Hpost)".
    iApply KVS_erase_spec_notin_pre_gen; eauto; iFrame "∗%".
    iSplit; first (iPureIntro;done).
    iNext;iNext.
    iIntros "(%Heq_sb & %Hku & %Hbounds & Hres)".
    iApply "Hpost"; iFrame.
