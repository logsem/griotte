...
Section KVS_spec_read_safe.
  ...
  (*** Safe entry point  *)
  Lemma kvs_read_entry_point_spec
    ...
    WSealed ot_switcher (SCap true RO g_kvs_exp_tbl b_kvs_exp_tbl e_kvs_exp_tbl kvs_read_exp_tbl_addr) ↦□ₑ kvs_read_nargs ∗
    WSealed ot_switcher (SCap true RO Local b_kvs_exp_tbl e_kvs_exp_tbl kvs_read_exp_tbl_addr) ↦□ₑ kvs_read_nargs
    -∗
    ot_switcher_prop W C (WCap true RO g_kvs_exp_tbl b_kvs_exp_tbl e_kvs_exp_tbl kvs_read_exp_tbl_addr).
  Proof.
    iIntros
    ...
    iFrame "#".
    iSplit; first done.
    iSplit; first by (iPureIntro; rewrite /kvs_read_exp_tbl_addr /kvs_read_exp_tbl_off; solve_addr).
    iSplit; first by (iPureIntro; rewrite /kvs_read_exp_tbl_addr /kvs_read_exp_tbl_off; solve_addr).
    iSplit; first by (iPureIntro; rewrite /kvs_read_exp_tbl_addr /kvs_read_exp_tbl_off; solve_addr).
    iSplit; first (iPureIntro; rewrite /kvs_read_nargs; lia).
    iSplit.
    { iPureIntro.
    ...
    iExtractList "Hrmap" [ct1; ct2; ctp; cnull; ca0; ca1] as ["Hct1"; "Hct2"; "Hctp"; "Hcnull"; "Hca0"; "Hca1"].

    (* General purpose registers *)
    iAssert (interp W0 C wca0) as "#Hinterp_wca0".
    { iApply "Hinterp_rmap"; eauto; by rewrite /kvs_read_nargs. }
