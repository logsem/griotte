...
Section fundamental.
  ...
  Lemma load_case (W : WORLD) (C : CmptName) (regs : leibnizO Reg)
    ...
    (w : Word) (ρ : region_type) (dst src : RegName) (P:D) (cstk : CSTK) (Ws : list WORLD) (wstk : Word)
    (Nswitcher : namespace) :
    ftlr_instr W C regs p p' g b e a w (Load dst src) ρ P cstk Ws wstk Nswitcher.
  Proof.
    ...
    { apply incrementPC_Some_inv in Hincr.
      ...
      iApply ("IH" $! _ _ _ _ regs' with "[%] [] [Hmap] [//] [$Hr] [$Hsts] [$Hcont] [//] [$Hown] [$Htframe]").
