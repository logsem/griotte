...
Section heap.
  ...
  Proof.
    ...
    set decode := (fun n =>
                     ...
                     else if decide (n = 2) then Some Revoked
                          else None)%positive.
  ...
  Proof.
    ...
    destruct ρ; try (destruct Hne; exfalso; congruence); try congruence.
  ...
  Proof.
    ...
    destruct ρ; try (destruct Htp; exfalso; congruence); try congruence.
    destruct (isWL p) eqn:Hpwl.
