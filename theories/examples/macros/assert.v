  ...
  *)
  ...
  Definition assert_inv (b a_flag e : Addr) : iProp Σ :=
    (∃ cap_addr,
       ...
       ⌜(a_flag + 1)%a = Some e⌝ ∗
       cap_addr ↦ₐ WCap RW Global a_flag e a_flag).

  Lemma assert_subroutine_spec g b a_flag e cont n1 n2 flag N E φ :
    ↑N ⊆ E →
  ...
  Lemma assert_success_spec g b a_flag e cont n1 n2 N E φ :
    ↑N ⊆ E →
    n1 = n2 →
    (  na_inv logrel_nais N (assert_inv b a_flag e)
     ∗ na_own logrel_nais E
