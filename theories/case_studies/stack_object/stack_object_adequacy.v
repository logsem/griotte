...
Section Adequacy.
  ...
  Proof.
    ...
    { intro H ; subst SO_f C_f ; simplify_eq.
    ...
    { intro H ; subst SO_f C_g ; simplify_eq.
      pose proof cmpts_disjoints as Hdisjoint.
      rewrite /disjoint /Cmpt_Disjoint /disjoint_cmpt /cmpt_region in Hdisjoint.
      assert (
          cmpt_exp_tbl_region main_cmpt  ## cmpt_exp_tbl_region C_cmpt
    ...
    iMod (
       entry_init (
           {[
               ...
               (seal_capability SO_f (ot_switcher switcher_cmpt)) := 2;
               (borrow (seal_capability SO_f (ot_switcher switcher_cmpt))) := 2
           ]}
    ...
    iMod (na_inv_alloc logrel.logrel_nais _ soN _ with "Hmain_code") as "#Hmain_code".
    ...
    iAssert (ot_switcher_prop W0' C (WSealable SO_f)) as "#ot_switcher_SO_f".
    {
      ...
      iApply (stack_object_f_spec _ _ _ _ _ _ _ _ _ _ _ C_f W0' assertN switcherN soN soN)
      ; last iFrame "#"; auto.
      + solve_ndisj.
      + solve_ndisj.
      + solve_ndisj.
    ...
    iAssert (ot_switcher_prop W0' C (WSealable SO_f')) as "#ot_switcher_STK_f_borrow".
    {
      subst SO_f'.
      iEval (rewrite main_imports) in "Hinv_etbl_entry_awkward".
      pose proof (cmpt_exp_tbl_pcc_size main_cmpt) as H0.
    ...
    { by subst W0. }
    iMod
      (sealing_map_alloc W0 C ot_switcher_propC ot_switcher {[WSealable SO_f; WSealable SO_f' ]}
