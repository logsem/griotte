...
Section Adequacy.
  ...
  Proof.
    ...
    { apply Forall_true; intros; done. }
    {
      ...
      iIntros "[#HC_imports #HC_data]".
      rewrite C_imports_addr big_opL_app.
      iDestruct "HC_imports" as "[HC_imports HC_code]".
      iEval (cbn) in "HC_imports".
      iDestruct "HC_imports" as "(#HC_imports_0 & #HC_imports_1 & #HC_imports_2 & _)".
      iAssert ((
          interp W4 C
